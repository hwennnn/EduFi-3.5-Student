...
|                  Container Name                  |                  Description                   | Exposed Port Number | Links                                                                                                                                                                         |
| :----------------------------------------------: | :--------------------------------------------: | :-----------------: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| [edufi_student_backend](backend/students/server) |    REST API Server for Student Microservice    |        9211         | [DockerHub](https://hub.docker.com/r/hwendev/edufi_student_backend) <br> [Github Packages](https://github.com/hwennnn/EduFi-3.5-Student/pkgs/container/edufi_student_backend) |
...
|    [edufi_mock_backend](backend/mock/server)     |       REST API Server for Mock Database        |        9212         | [DockerHub](https://hub.docker.com/r/hwendev/edufi_mock_backend) <br> [Github Packages](https://github.com/hwennnn/EduFi-3.5-Student/pkgs/container/edufi_mock_backend)       |
|           [edufi_proxy](backend/proxy)           |              Nginx Reverse Proxy               |        9210         | [DockerHub](https://hub.docker.com/r/hwendev/edufi_proxy) <br> [Github Packages](https://github.com/hwennnn/EduFi-3.5-Student/pkgs/container/edufi_proxy)                     |
...
![CI Screenshot 1](docs/images/ci-1.png) <br>
...
![CI Result](docs/images/ci-result.png) <br>
...
![CD Screenshot 1](docs/images/cd-1.png) <br>
...
![CD Screenshot 2](docs/images/cd-2.png) <br>
