...
As mentioned earlier in the main README, as of 29 January 2022, I was having difficulties to consume other microservices, hence I decided to create a mock database and mock server to satisfy the necessary requirements and for demo purposes.
